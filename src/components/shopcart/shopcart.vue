<template>
  <div class="shopcart">
    ...
    <div class="ball-container">
      <transition v-for="ball in balls" name="drop" @before-enter="dropBeforeEnter" @enter="dropEnter" @after-enter="dropAfterEnter">
...
<style>
  ...
  .ball-container .ball.drop-leave-active {
    transition: all 0.4s cubic-bezier(0.49, -0.29, 0.75, 0.41);
  }

  .ball-container .ball.drop-leave-active .inner {
    width: 16px;
    height: 16px;
    border-radius: 50%;
    background: rgb(0, 160, 220);
